...
class Zenodo(Search):
    ...
    def _get_zenodo_hits(self, api_response) -> List[GeneralizedHit]:  # TODO: set response type
        return [self._parse_one_zenodo_hit(zenodo_hit) for zenodo_hit in api_response['hits']['hits']]
